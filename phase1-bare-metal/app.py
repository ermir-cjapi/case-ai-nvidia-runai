"""
FastAPI LLM Inference Server - Phase 1: Bare Metal

This server loads Llama 3.2 3B (or Phi-3 Mini) directly to GPU
and provides a /generate endpoint for text generation.
